...
export default function Dashboard({
  ...
  // Update the logic for displayedCourses and filteredCourses
  ...
  const filteredCourses = courses.filter(course => enrollments.some((enrollment: any) => enrollment.course === course._id));
