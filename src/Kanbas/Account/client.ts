...
export const USERS_API = `https://kanbas-node-server-app-7-q75f.onrender.com/api/users`;
const axiosWithCredentials = axios.create({ withCredentials: true });
export const ENROLLMENTS_API = `https://kanbas-node-server-app-7-q75f.onrender.com/api/enrollments`;
...
export const signin = async (credentials: any) => {
  ...
  export const findAllCourses=async()=>{
    const {data}=await axiosWithCredentials.get(`https://kanbas-node-server-app-7-q75f.onrender.com/api/courses`);
    return data;
  }
